...
enum FieldIndex {
    ...
    static let all: [FieldEntry] = [
        ...
        .init(id: "money.availability", label: "Availability", tab: .money,
              keywords: ["territories", "countries", "regions", "where"]),
        .init(id: "money.appStoreTerritories", label: "App Store territories",
              tab: .money, keywords: ["countries", "regions", "apple"]),
